...
ActiveRecord::Schema.define(:version => 20150827153918) do
  ...
  add_index "rental_property_season_translations", ["locale"], :name => "index_rental_property_season_translations_on_locale"
